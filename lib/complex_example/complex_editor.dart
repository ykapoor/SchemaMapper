...
import 'package:json_mapper_arrows/complex_example/components/rainbow.dart';
import 'package:json_mapper_arrows/complex_example/components/random.dart';
  ...
  onCanvasTapUp(TapUpDetails details) {
    ...
    canvasWriter.model.addComponent(
      ComponentData(
          ...
          type:
              'rainbow' //['rainbow', 'random', 'flutter'][math.Random().nextInt(3)],
          ),
    );
  }
}
